...
Through the set of data attached to the files in CSV format, we performed some data modeling operations, adding and extracting some results through maps and visualizations, shortening some duplicate records, and deleting records that contain empty values.
